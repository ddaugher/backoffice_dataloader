...
--project --name Jewel Designer --customer_id 1 --region_id 1 --status Forecasted
--project --name Bread Buddy --customer_id 2 --region_id 1 --status Forecasted
--project --name Project42 --customer_id 3 --region_id 1 --status Booked
--project --name Daily Yoga App --customer_id 4 --region_id 1 --status Forecasted
--project --name From The Ashes App --customer_id 4 --region_id 1 --status Imminent
--project --name Fleet Manager --customer_id 5 --region_id 1 --status Draft
--project --name Jewel Designer Extension --customer_id 1 --region_id 1 --status Draft
--project --name Bread Buddy Phase 2 --customer_id 2 --region_id 1 --status Draft
--project --name Project42 Extension --customer_id 3 --region_id 1 --status Forecasted
--project --name Project42 Draft --customer_id 3 --region_id 1 --status Draft
